...
describe('Comic Management Detail Component', () => {
      ...
      providers: [
        {
          ...
          useValue: { data: of({ comic: { id: 123 } }) },
        },
      ],
    })
      .overrideTemplate(ComicDetailComponent, '')
      .compileComponents();
  ...
  describe('OnInit', () => {
    it('Should load comic on init', () => {
      // WHEN
      comp.ngOnInit();

      // THEN
      expect(comp.comic).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
