...
describe('Characters Management Detail Component', () => {
  let comp: CharactersDetailComponent;
      ...
      providers: [
        {
          ...
          useValue: { data: of({ characters: { id: 123 } }) },
        },
      ],
    })
      .overrideTemplate(CharactersDetailComponent, '')
      .compileComponents();
  ...
  describe('OnInit', () => {
    it('Should load characters on init', () => {
      ...
      // THEN
      expect(comp.characters).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
